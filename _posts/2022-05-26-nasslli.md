...
4 higher-order quantifiers and identity $(\forall_\sigma :(\sigma \to t)\to t)$ and formulate Hibert-style axiomatic systems to see how they behave.（先不用看 model theoretic results and see how we can interpret them）
