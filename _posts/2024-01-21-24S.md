...
週四：挺细节的讲了1.4.C 1.4.E（还有filtered condition） 我觉得我需要好好写一下1.4.G 1.5开了个头 主要讲了定义(最重要的是domain的arrow需要反个方向 仔细讲了一下1.5.D 1.5B 1.5E 给了个hint

#### 第四周

读完1.5 1，6读到1.6.6（但是到此为止都没什么exercise）
